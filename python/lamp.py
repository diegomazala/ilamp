...
if __name__ == "__main__":
    ...
    #D = np.loadtxt("iris.data", delimiter=",")
    ...
    #sample_ids = np.random.randint(low=0,high=150,size=(20,))  # getting 20 random points in D as control points
    ...
    np.savetxt(output_2d_file, proj, fmt='%.5f')
