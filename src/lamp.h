...
protected:
	...
	{
		control_points = Eigen::Matrix<decimal_t, Eigen::Dynamic, Eigen::Dynamic>(X.rows(), 2);
		control_points_ids = Eigen::Matrix<Eigen::DenseIndex, Eigen::Dynamic, Eigen::Dynamic>(X.rows(), 1);
	...
	{
		control_points_data = Eigen::Matrix<decimal_t, Eigen::Dynamic, Eigen::Dynamic>(X.rows(), X.cols());
